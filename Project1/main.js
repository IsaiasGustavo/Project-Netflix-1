let CL = 'Cavaleiro da Lua';
let SON = 'Sonic';
let VK = 'Vikings Valhalla';
let AEA = 'Ainda Estou Aqui';
let SS = 'Sem Saída';
let EN = 'Encanto';
let PA = 'Projeto Adam';
let HA = 'Homem Aranha Sem volta pra casa';
let EPH = 'Euphoria';
let AG = 'A anatomia de GREY';
let HT = 'Hotel Transilvania';
let PG = 'Pasión de Gavilantes';
let ML = 'Metal Lords';
let TWD = 'The Walking Dead';
let OC = 'O comando';
let CN = 'Caranguejo Negro';
let EL = 'Elite';
let TGD = 'The Good Doctor';




document.getElementById("c0").onclick = function(){
    document.getElementById("txt").innerHTML = CL;
